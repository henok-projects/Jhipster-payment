...
class PaymentResourceIT {
    ...
    private static final Integer DEFAULT_PAYMENT_AMOUT = 1;
    private static final Integer UPDATED_PAYMENT_AMOUT = 2;
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment()
            .cik(DEFAULT_CIK)
            .ccc(DEFAULT_CCC)
            .paymentAmout(DEFAULT_PAYMENT_AMOUT)
            .name(DEFAULT_NAME)
            .email(DEFAULT_EMAIL)
            .phone(DEFAULT_PHONE);
        return payment;
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment()
            .cik(UPDATED_CIK)
            .ccc(UPDATED_CCC)
            .paymentAmout(UPDATED_PAYMENT_AMOUT)
            .name(UPDATED_NAME)
            .email(UPDATED_EMAIL)
            .phone(UPDATED_PHONE);
        return payment;
    ...
    void createPayment() throws Exception {
        ...
        assertThat(testPayment.getPaymentAmout()).isEqualTo(DEFAULT_PAYMENT_AMOUT);
    ...
    void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.[*].paymentAmout").value(hasItem(DEFAULT_PAYMENT_AMOUT)))
    ...
    void getPayment() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.paymentAmout").value(DEFAULT_PAYMENT_AMOUT))
    ...
    void putNewPayment() throws Exception {
        ...
        assertThat(testPayment.getPaymentAmout()).isEqualTo(UPDATED_PAYMENT_AMOUT);
